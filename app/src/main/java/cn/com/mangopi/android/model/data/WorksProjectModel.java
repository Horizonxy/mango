...
public class WorksProjectModel {
    ...
    public Subscription replyProjectTeam(Map<String, Object> map, Action0 onSubscribe, Subscriber<RestResult<Object>> subscriber){
        return RxJavaUtils.schedulersIoMainOnSubscribe(ApiManager.replyProjectTeam(map), onSubscribe).subscribe(subscriber);
    }
