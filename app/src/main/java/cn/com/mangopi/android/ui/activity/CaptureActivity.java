 ...
 * @author 蒋先明
 */
public class CaptureActivity extends BaseTitleBarActivity implements Callback, com.zbar.lib.CaptureActivity {
...
//		mCropLayout = (RelativeLayout) findViewById(R.id.capture_crop_layout);
	...
	public void handleDecode(String result) {
		...
		bundle.putString(Constants.BUNDLE_SCAN_RESULT, result);
	...
	private void initCamera(SurfaceHolder surfaceHolder) {
		try {
			...
			ioe.printStackTrace();
			AppUtils.showToast(this, "无法打开摄像头，请检测是否授予摄像头权限");
			return;
		} 
		if (handler == null) {
