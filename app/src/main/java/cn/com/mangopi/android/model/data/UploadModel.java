...
public class UploadModel {
    ...
    public Subscription upload(long entityId, int entityTypeId, MultipartBody.Part file, Action0 onSubscribe, Subscriber<RestResult<UploadBean>> subscriber){
    ...
    public Subscription uploadWithOutLoading(long entityId, int entityTypeId, MultipartBody.Part file, Subscriber<RestResult<UploadBean>> subscriber){
